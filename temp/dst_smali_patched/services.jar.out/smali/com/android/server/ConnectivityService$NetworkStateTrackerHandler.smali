...
.method private maybeHandleNetworkAgentMessage(Landroid/os/Message;)V
    ...
    const-string v8, " has CS-managed capability."
    ...
    const-string v7, "Exception in addVpnUidRanges: "
    ...
    const-string v7, "Exception in removeVpnUidRanges: "
    ...
    :cond_5
    const-string v6, "ERROR: already-connected network explicitly selected."
...
.method private maybeHandleNetworkMonitorMessage(Landroid/os/Message;)Z
    ...
    const-string v2, "Avoiding captive portal network: "

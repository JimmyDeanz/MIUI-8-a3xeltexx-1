...
.method private handleCreateService(Landroid/app/ActivityThread$CreateServiceData;)V
    ...
    invoke-static {p0, v12, v3}, Landroid/app/ContextImpl;->createAppContext(Landroid/app/ActivityThread;Landroid/app/LoadedApk;I)Landroid/app/ContextImpl;
    ...
    iget-object v3, p1, Landroid/app/ActivityThread$CreateServiceData;->callerActivityToken:Landroid/os/IBinder;

    if-eqz v3, :cond_1

    iget-object v3, p0, Landroid/app/ActivityThread;->mActivities:Landroid/util/ArrayMap;

    iget-object v4, p1, Landroid/app/ActivityThread$CreateServiceData;->callerActivityToken:Landroid/os/IBinder;
    ...
    invoke-virtual {v3, v9, v2}, Lcom/samsung/android/multidisplay/common/ContextRelationManager;->createContext(Landroid/content/Context;Landroid/content/Context;)V
    ...
    invoke-interface {v3, v4, v5, v7, v13}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_2
    ...
    .restart local v9    # "callerActivityContext":Landroid/content/Context;
    :cond_3
    :try_start_3
    invoke-static {}, Lcom/samsung/android/multidisplay/common/ContextRelationManager;->getInstance()Lcom/samsung/android/multidisplay/common/ContextRelationManager;
    ...
    invoke-virtual {v3, v4, v2}, Lcom/samsung/android/multidisplay/common/ContextRelationManager;->createContext(Landroid/content/Context;Landroid/content/Context;)V
    :try_end_3

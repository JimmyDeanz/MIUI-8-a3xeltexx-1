...
.method static generateBitmap(Landroid/content/Context;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    const-string v13, "android.wallpaper.settings_systemui_transparency"
    ...
    const-string v13, "Theme wallpaper downsize."
    ...
    invoke-static {v0, v9}, Landroid/app/WallpaperManager;->resizeBitmap(Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
...
.method private static getDefaultWallpaperID(Landroid/content/Context;)I
    ...
    const-string v6, "no color wallpaper get default wallpaper id:"
...
.method public static openDefaultWallpaper(Landroid/content/Context;)Ljava/io/InputStream;
    ...
    invoke-static {v1}, Landroid/app/WallpaperManager$Globals;->access$400(Landroid/app/WallpaperManager$Globals;)Ljava/io/File;
...
.method private static readColorId()I
    ...
    const-string v5, "readWindowType:"
...
.method public clear()V
    ...
    .local v1, "defaultWallpaperStream":Ljava/io/InputStream;
    sget-object v5, Landroid/app/WallpaperManager;->sGlobals:Landroid/app/WallpaperManager$Globals;

    # invokes: Landroid/app/WallpaperManager$Globals;->getDefaultWallpaperFile()Ljava/io/File;
    invoke-static {v5}, Landroid/app/WallpaperManager$Globals;->access$400(Landroid/app/WallpaperManager$Globals;)Ljava/io/File;
    ...
    invoke-static {v5}, Landroid/app/WallpaperManager;->getDefaultWallpaperID(Landroid/content/Context;)I

    move-result v5

    invoke-virtual {p0, v5}, Landroid/app/WallpaperManager;->setResource(I)V
    ...
    const-string v7, "cannot get csc wallpaper(setStream):"
    ...
    const-string v7, "cannot get csc wallpaper(close inputstream):"
    ...
    const-string v6, "Can\'t put value of SETTINGS_SYSTEMUI_TRANSPARENCY"
...
.method public clear(I)V
    ...
    # invokes: Landroid/app/WallpaperManager$Globals;->getDefaultWallpaperFile()Ljava/io/File;
    invoke-static {v4}, Landroid/app/WallpaperManager$Globals;->access$400(Landroid/app/WallpaperManager$Globals;)Ljava/io/File;
...
.method public setResource(I)V
    ...
    # getter for: Landroid/app/WallpaperManager$Globals;->mService:Landroid/app/IWallpaperManager;
    invoke-static {v6}, Landroid/app/WallpaperManager$Globals;->access$200(Landroid/app/WallpaperManager$Globals;)Landroid/app/IWallpaperManager;

...
.method static constructor <clinit>()V
    ...
    const-string v1, "uses-configuration"
    ...
    const-string v1, "uses-gl-texture"
    ...
    const-string v1, "supports-input"
...
.method private static collectCertificates(Landroid/content/pm/PackageParser$Package;Ljava/io/File;I)V
    ...
    :try_start_2
    const-string v25, "strictJarFileCtor"
...
.method private isPowerOffAlarmPackage(Ljava/lang/String;)Z
    ...
    const-string v4, "power off alarm app array is empty "
...
.method private parseBaseApkCommon(Landroid/content/pm/PackageParser$Package;Ljava/util/Set;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    :cond_14
    const-string v5, "uses-permission-sdk-m"
    ...
    const-string v5, "uses-permission-sdk-23"
    ...
    :cond_16
    const-string v5, "uses-configuration"
    ...
    :cond_33
    const-string v5, "protected-broadcast"
    ...
    :cond_38
    const-string v5, "original-package"
    ...
    .end local v34    # "name":Ljava/lang/String;
    :cond_3e
    const-string v5, "uses-gl-texture"
    ...
    :cond_40
    const-string v5, "supports-input"
    ...
    :cond_43
    const-string v5, "restrict-update"
...
.method private parseIntent(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;ZZLandroid/content/pm/PackageParser$IntentInfo;[Ljava/lang/String;)Z
    ...
    const-string v15, "sspPattern not allowed here; ssp must be literal"
    ...
    const-string v15, "pathPattern not allowed here; path must be literal"

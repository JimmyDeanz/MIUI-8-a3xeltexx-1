...
.method static constructor <clinit>()V
    ...
    const-string v1, "message_expiration_time_long"
    ...
    const-string v3, "mms:default_randomization=2000,5000,10000,20000,40000,80000:5000,160000:5000,320000:5000,640000:5000,1280000:5000,1800000:5000"

    aput-object v3, v2, v6

    const-string v3, "others:max_retries=3, 5000, 5000, 5000"
    ...
    const-string v1, "support_video_conference_call_bool"
    ...
    const-string v1, "wfc_operator_error_codes_string_array"

    invoke-virtual {v0, v1, v7}, Landroid/os/PersistableBundle;->putStringArray(Ljava/lang/String;[Ljava/lang/String;)V

    sget-object v0, Landroid/telephony/CarrierConfigManager;->sDefaults:Landroid/os/PersistableBundle;

    const-string v1, "wfc_spn_format_idx_int"
    ...
    const-string v1, "reject_ggsn_perm_failure"

    invoke-virtual {v0, v1, v6}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    sget-object v0, Landroid/telephony/CarrierConfigManager;->sDefaults:Landroid/os/PersistableBundle;

    const-string v1, "protocol_errors_perm_failure"
    ...
    const-string v1, "ratchet_rat_families"
    ...
    const-string v1, "wifi_calls_can_be_hd_audio"

    invoke-virtual {v0, v1, v6}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    sget-object v0, Landroid/telephony/CarrierConfigManager;->sDefaults:Landroid/os/PersistableBundle;

    const-string v1, "video_calls_can_be_hd_audio"
    ...
    const-string v1, "stk_disable_launch_browser_bool"

    invoke-virtual {v0, v1, v5}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    sget-object v0, Landroid/telephony/CarrierConfigManager;->sDefaults:Landroid/os/PersistableBundle;

    const-string v1, "carrier_map_anonymous_to_restricted"
    ...
    const-string v1, "editable_tether_apn_bool"

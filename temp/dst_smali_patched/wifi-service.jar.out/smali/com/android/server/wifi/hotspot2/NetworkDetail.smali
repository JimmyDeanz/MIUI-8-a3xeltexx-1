...
.method public constructor <init>(Ljava/lang/String;[Landroid/net/wifi/ScanResult$InformationElement;Ljava/util/List;I)V
    ...
    const-string v28, "Null information elements"
    ...
    const-string v28, "Malformed IE string (no SSID)"
    ...
    const-string v28, "Failed to decode SSID in dubious IE string"
    ...
    const-string v29, ", Invalid SupportedRates!!!"
...
.method public toString()Ljava/lang/String;
    ...
    .prologue
    const-string v0, "NetworkInfo{SSID=\'%s\', HESSID=%x, BSSID=%x, StationCount=%d, ChannelUtilization=%d, Capacity=%d, Ant=%s, Internet=%s, VenueGroup=%s, VenueType=%s, HSRelease=%s, AnqpDomainID=%d, AnqpOICount=%d, RoamingConsortiums=%s}"

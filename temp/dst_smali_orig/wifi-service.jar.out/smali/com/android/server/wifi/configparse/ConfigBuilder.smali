...
.method private static buildConfig(Lcom/android/server/wifi/hotspot2/pps/HomeSP;Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/security/PrivateKey;)Landroid/net/wifi/WifiConfiguration;
    ...
    const-string v4, "Unsupported EAP Method: "
    ...
    :cond_0
    const-string v2, "WCFG"

    const-string v3, "Client cert and/or key unnecessarily included with EAP-TTLS profile"
    ...
    const-string v4, "Client/CA cert and/or key unnecessarily included with "
...
.method private static buildTLSConfig(Lcom/android/server/wifi/hotspot2/pps/HomeSP;Ljava/util/List;Ljava/security/PrivateKey;Ljava/security/cert/X509Certificate;)Landroid/net/wifi/WifiConfiguration;
    ...
    const-string v12, "No key and/or cert passed for EAP-TLS"
    ...
    const-string v13, "Invalid certificate type for TLS: "
    ...
    const-string v12, "No certificate in chain matches supplied fingerprint"
...
.method private static parse(Lcom/android/server/wifi/configparse/MIMEContainer;)Landroid/net/wifi/WifiConfiguration;
    ...
    const-string v18, "Malformed MIME content: not multipart"
    ...
    const-string v18, "application/x-passpoint-profile"
    ...
    .end local v13    # "moText":Ljava/lang/String;
    :cond_2
    const-string v18, "application/x-x509-ca-cert"
    ...
    const-string v18, "Can\'t read non base64 encoded cert"
    ...
    :cond_3
    const-string v18, "application/x-pkcs12"
    ...
    const-string v18, "Can\'t read non base64 encoded key"
    ...
    const-string v19, "---- Start PKCS12 info "
    ...
    const-string v19, "WCFG"

    new-instance v20, Ljava/lang/StringBuilder;

    invoke-direct/range {v20 .. v20}, Ljava/lang/StringBuilder;-><init>()V

    const-string v21, "Element in cert chain is not an X509Certificate: "
    ...
    const-string v18, "---- End PKCS12 info."
    ...
    const-string v18, "Missing profile"

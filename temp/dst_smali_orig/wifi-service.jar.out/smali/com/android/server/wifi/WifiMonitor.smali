...
.method private declared-synchronized dispatchEvent(Ljava/lang/String;)Z
    ...
    const-string v4, "Ignoring event from unexpected interface: "
    ...
    const-string v4, "Dropping malformed event (unparsable iface): "
...
.method private dispatchEvent(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v4, "CTRL-EVENT-BSS-ADDED"
    ...
    const-string v4, "pre-shared key may be incorrect"
    ...
    :cond_9
    const-string v4, "ANQP-QUERY-DONE"
    ...
    const-string v6, "Bad ANQP event string: \'"
    ...
    const-string v6, "Bad Icon event string: \'"
    ...
    .end local v24    # "iae":Ljava/lang/IllegalArgumentException;
    :cond_b
    const-string v4, "HS20-SUBSCRIPTION-REMEDIATION"
    ...
    :cond_c
    const-string v4, "HS20-DEAUTH-IMMINENT-NOTICE"
    ...
    :cond_e
    const-string v4, "Trying to associate with "
    ...
    :cond_f
    const-string v4, "Associated with "
    ...
    :cond_10
    const-string v4, "Authentication with"
    ...
    const-string v6, "couldn\'t identify event type - "
    ...
    const-string v5, "Received wpa_supplicant event with empty event name"
    ...
    const-string v6, "Failed to parse out BSSID from \'"
    ...
    .end local v20    # "event":I
    :cond_25
    const-string v4, "SSID-TEMP-DISABLED"
    ...
    .end local v20    # "event":I
    :cond_26
    const-string v4, "SSID-REENABLED"
    ...
    .end local v20    # "event":I
    :cond_29
    const-string v4, "SUBNET-STATUS-UPDATE"
    ...
    const-string v5, "too many recv errors, closing connection"
    ...
    const-string v5, "Assoc Reject: Could not parse assoc reject string"
...
.method private handleAnqpResult(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "Unexpected ANQP result notification"
    ...
    const-string v2, "Bad MAC address in ANQP response: "
...
.method private handleEvent(ILjava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "handleEvent unknown: "
...
.method private handleIconResult(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v6, "Incorrect number of segments"
...
.method private handleNetworkStateChange(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "handleNetworkStateChange: Couldnt find BSSID in event string"
    ...
    const-string v2, "handleNetworkStateChange: Could not parse disconnect string"
    ...
    const-string v3, "WifiMonitor notify network disconnect: "
...
.method private handleRequests(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "didn\'t find SSID "
    ...
    const-string v2, "couldn\'t parse SIM auth request - "
    ...
    const-string v2, "couldn\'t identify request type - "
...
.method private handleSupplicantStateChange(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "Invalid supplicant state: "
...
.method private handleSupplicantVendorDebugEvent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v6, "IP subnet status change event - "
    ...
    const-string v5, "IP subnet status event: Invalid tokens"
    ...
    const-string v5, "IP subnet status event: Invalid nameValue"
...
.method private notifyIpSubnetStatusChange(Ljava/lang/String;I)V
    ...
    const-string v2, "Invalid IP subnet status: "
...
.method private sendMessage(Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v8, "Sending to all monitors because there\'s no matching iface"
...
.method public declared-synchronized killSupplicant(Z)V
    ...
    const-string v4, "killSupplicant p2p"
...
.method public declared-synchronized startMonitoring(Ljava/lang/String;)V
    ...
    const-string v3, "startMonitoring("
    ...
    const-string v3, ") with mConnected = "

...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/WifiNative;Lcom/android/server/wifi/FrameworkFacade;Lcom/android/server/wifi/Clock;Landroid/os/UserManager;Landroid/security/KeyStore;)V
    ...
    const-string v2, "/data/misc/wifi/PerProviderSubscription.conf"
...
.method private addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;I)Lcom/android/server/wifi/NetworkUpdateResult;
    ...
    const-string v6, "Failed to set network metadata. Removing config "
...
.method private cacheScanResultForConfig(Landroid/net/wifi/WifiConfiguration;Lcom/android/server/wifi/ScanDetail;Lcom/android/server/wifi/hotspot2/PasspointMatch;)V
    ...
    const-string v9, "WifiConfigManager"
...
.method private readNetworkVariableFromSupplicantFile(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v6, "readNetworkVariableFromSupplicantFile configKey=["
...
.method private removeConfigAndSendBroadcastIfNeeded(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    const-string v2, "removeNetwork  key="
...
.method private removeUserSelectionPreference(Ljava/lang/String;)V
    ...
    const-string v6, "removeUserSelectionPreference: key is "
...
.method dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .prologue
    const-string v4, "Dump of WifiConfigManager"
...
.method enableNetwork(Landroid/net/wifi/WifiConfiguration;ZI)Z
    ...
    const-string v2, "enableNetwork(disableOthers=true, uid="
    ...
    const-string v1, "enableNetwork(disableOthers=false) "
...
.method forgetNetwork(I)Z
    ...
    const-string v1, "Failed to forget network "
...
.method public getIsCarrierNetworkEnabledByUser()Z
    ...
    const-string v3, "wifi_connect_carrier_networks"
...
.method getPrivilegedSavedNetworks()Ljava/util/List;
    ...
    const-string v7, "Failed to parse MO from "
...
.method public getSavedNetworkFromScanDetail(Lcom/android/server/wifi/ScanDetail;)Ljava/util/List;
    ...
    const-string v8, "getSavedNetworkFromScanDetail(): try "
...
.method public linkConfiguration(Landroid/net/wifi/WifiConfiguration;)V
    ...
    const-string v2, "linkConfiguration: Attempting to link config "
    ...
    const-string v2, " that is not visible to the current user."
...
.method loadConfiguredNetworks()V
    ...
    const-string v7, "Ignoring network "
    ...
    const-string v7, " because the configKey loaded "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v7, "from wpa_supplicant.conf is not valid."
    ...
    const-string v7, "loadConfiguredNetworks loaded "
    ...
    const-string v7, " networks (for all users)"
    ...
    const-string v6, "/data/misc/wifi/wpa_supplicant.conf.tmp"
...
.method public notifyIconReceived(Lcom/android/server/wifi/hotspot2/IconEvent;)V
    ...
    const-string v2, "android.net.wifi.PASSPOINT_ICON_RECEIVED"
...
.method readPasspointConfig(Ljava/util/Map;Landroid/util/SparseArray;)V
    ...
    const-string v17, "WifiConfigManager"

    new-instance v18, Ljava/lang/StringBuilder;

    invoke-direct/range {v18 .. v18}, Ljava/lang/StringBuilder;-><init>()V

    const-string v19, "Looking for "
    ...
    const-string v18, "Could not read /data/misc/wifi/PerProviderSubscription.conf : "
    ...
    const-string v19, " passpoint configs"
...
.method public removeNetworksForApp(Landroid/content/pm/ApplicationInfo;)Ljava/util/Set;
    ...
    const-string v6, "Remove all networks for app "
...
.method removeNetworksForUser(I)Ljava/util/Set;
    ...
    const-string v6, "Remove all networks for user "
...
.method saveNetwork(Landroid/net/wifi/WifiConfiguration;I)Lcom/android/server/wifi/NetworkUpdateResult;
    ...
    const-string v5, "WifiConfigManager: saveNetwork netId"
    ...
    const-string v6, "WifiConfigManager saveNetwork, size="
    ...
    const-string v6, "WifiConfigManager: removed from ephemeral blacklist: "
    ...
    const-string v5, "WifiConfigManager: saveNetwork got it back netId="
    ...
    const-string v6, "WifiConfigManager: re-enabling: "
    ...
    const-string v6, "WifiConfigManager: saveNetwork got config back netId="
...
.method selectNetwork(Landroid/net/wifi/WifiConfiguration;ZI)Z
    ...
    const-string v3, ": Network config is not "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, "visible to current user."
    ...
    const-string v3, "Setting SSID for WPA supplicant network "
...
.method public tryEnableQualifiedNetwork(I)Z
    ...
    const-string v1, "updateQualifiedNetworkstatus invalid network."
...
.method updateNetworkSelectionStatus(Landroid/net/wifi/WifiConfiguration;I)Z
    ...
    const-string v2, "Enable network:"
    ...
    const-string v2, "disable counter of "
    ...
    const-string v2, "and threshold is: "
...
.method updateNetworkStatus(Landroid/net/wifi/WifiConfiguration;I)Z
    ...
    const-string v3, "Invalid Network disable reason:"
    ...
    const-string v2, "Need not change Qualified network Selection status since already enabled"
    ...
    const-string v3, "Re-enable network: "
    ...
    const-string v3, "Do nothing. Alreay permanent disabled! "
    ...
    const-string v3, "Do nothing. Already temporarily disabled! "
    ...
    const-string v3, "Configure new status:"

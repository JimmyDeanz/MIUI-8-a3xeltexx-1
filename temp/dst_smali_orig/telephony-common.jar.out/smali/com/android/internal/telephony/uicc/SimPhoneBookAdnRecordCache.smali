...
.method private clearUpdatingWriter()V
    ...
    const-string v1, "SimPhoneBookAdnRecordCache reset"
...
.method private log(Ljava/lang/String;)V
    ...
    .prologue
    const-string v0, "SimPhoneBookAdnRecordCache"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v2, "android.intent.action.ACTION_ADN_INIT_DONE"
    ...
    const-string v3, "broadcast intent ACTION_ADN_INIT_DONE for mPhoneId="
    ...
    const-string v3, "Init ADN done Exception: "
    ...
    :pswitch_1
    const-string v2, "Querying ADN record done"
    ...
    :pswitch_2
    const-string v2, "Loading ADN record done"
    ...
    .end local v14    # "i":I
    :pswitch_3
    const-string v2, "Loading all ADN records done"
    ...
    :pswitch_4
    const-string v2, "Update ADN record done"
    ...
    const-string v3, "Record number for added ADN is "
    ...
    const-string v3, "Record number for deleted ADN is "
    ...
    .end local v13    # "e":Ljava/lang/Exception;
    const-string v2, "The index for deleted ADN record did not match"
    ...
    const-string v3, "Record number for changed ADN is "
    ...
    .end local v13    # "e":Ljava/lang/Exception;
    const-string v2, "The index for changed ADN record did not match"
    ...
    .restart local v12    # "ar":Landroid/os/AsyncResult;
    const-string v2, "SIM REFRESH occurred"
...
.method public queryAdnRecord()V
    ...
    const-string v1, "start to queryAdnRecord"
    ...
    const-string v1, "SimPhoneBookAdnRecordCache"
...
.method public requestLoadAllAdnLike(Landroid/os/Message;)V
    ...
    const-string v0, "ADN cache has already filled in"
...
.method public updateSimPbAdnBySearch(Lcom/android/internal/telephony/uicc/AdnRecord;Lcom/android/internal/telephony/uicc/AdnRecord;Landroid/os/Message;)V
    ...
    const-string v6, "ADN cache has already filled in"
    ...
    const-string v6, "Sim PhoneBook Adn list not exist"
    ...
    const-string v7, "Sim PhoneBook Adn record don\'t exist for "
    ...
    const-string v6, "Sim PhoneBook Adn record is full"
    ...
    const-string v6, "Have pending update for Sim PhoneBook Adn"

...
.method private getTrustAgentInfo(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin$TrustAgentInfo;
    ...
    const-string v4, "trust-agent-component-options"
...
.method dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    const-string v2, "strongAuthUnlockTimeout="
    ...
    const-string v2, "keepUninstalledPackages="
    ...
    const-string v2, "organizationColor="
...
.method readFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    :cond_c
    const-string v3, "strong-auth-unlock-timeout"
    ...
    :cond_14
    const-string v3, "test-only-admin"
    ...
    :cond_1c
    const-string v3, "is_network_logging_enabled"
    ...
    const-string v3, "num-notifications"
    ...
    :cond_24
    const-string v3, "user-restrictions"
    ...
    :cond_25
    const-string v3, "short-support-message"
    ...
    const-string v5, "Missing text when loading short support message"
    ...
    const-string v5, "Missing text when loading long support message"
    ...
    :cond_2b
    const-string v3, "organization-color"
    ...
    const-string v5, "Missing text when loading organization name"
...
.method writeToXml(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    const-string v10, "strong-auth-unlock-timeout"
    ...
    const-string v10, "test-only-admin"
    ...
    const-string v10, "force_ephemeral_users"
    ...
    const-string v10, "is_network_logging_enabled"
    ...
    const-string v10, "num-notifications"
    ...
    const-string v10, "last-notification"
    ...
    const-string v10, "keep-uninstalled-packages"
    ...
    const-string v11, "user-restrictions"
    ...
    const-string v10, "short-support-message"
    ...
    const-string v10, "long-support-message"
    ...
    const-string v10, "organization-color"
    ...
    const-string v10, "organization-name"
